document.addEventListener("DOMContentLoaded", () => {
    ...
    const tourSteps = [
        { title: "Welcome", text: "This is your Sleep Intake Assistant. It guides patients through structured clinical intake.", element: null },
        { title: "Progress Bar", text: "This bar fills as the patient answers questions.", element: progressBar },
        { title: "Chat Window", text: "All patient interactions appear here.", element: chatWindow },
        { title: "Controls", text: "These buttons manage the intake flow.", element: controlsEl, lowerTooltip: true },
        { title: "Input Box", text: "Patients can type responses here.", element: inputAreaEl }
    ];
    ...
    function applyTooltipLower(apply) {
        if (apply) tourTooltip.classList.add("tooltip-lower");
        else tourTooltip.classList.remove("tooltip-lower");
    }
