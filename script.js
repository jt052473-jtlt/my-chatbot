document.addEventListener("DOMContentLoaded", () => {
  ...
  const allLanguages = [
    ...
    "French", "Korean", "Russian", "German", "Italian", "Portuguese", 
    "Hindi", "Japanese", "Polish", "Dutch", "Greek", "Urdu", "Persian", 
    "Hebrew", "Thai", "Swedish"
  ];
  ...
  // FIXED START DEMO LOGIC
  startDemoBtn.addEventListener("click", () => {
    // Clear only chat messages, not the tooltip/overlay
